...
<html>
    ...
    <body>
        <h1>SIMPLE LAPOR!</h1>
        <form method="POST" id="formlaporan" action="<?php echo e(route('store')); ?>" onsubmit="return validateForm()" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
    ...
    </body><?php /**PATH C:\application_laravel\IF3028-TUBESPEMWEB-RA-RC-2021-main\resources\views/form_page.blade.php ENDPATH**/ ?>