...
<div class="container">
    ...
    <form action="/lapor/save" method="post" enctype="multipart/form-data" onSubmit="validasi()" name="createLapor">
        ...
        <div>
            <textarea id="isi" name="isi_laporan" rows="3" required></textarea>
        </div>

        <div class="pilihAspek">
            <select id="aspek" name="aspek_pelaporan" required>
...
<div class="footer">
    <div class="footer">
        Rian Andri Waskito (119140030)<br>Samuel Jovial Pardede (119140104)
    </div>
</div>
