...
<body>
    ...
    <div class="isi-list">
        ...
        ?>
            <p style="font-size: 15pt;">{{$limited_string}}</p>
        </div> 

        <div class="atribut ">
            <a style="float: left">Lampiran : {{$d->file}}</p>
            
            <a href="#" onclick="showDetail({{ $d->id }})" style="color: blue;"> Lihat Selengkapnya ></a>
            <a href="#" onclick="edit({{ $d->id }})" style="color: orange;"> Edit&ensp;</a>
