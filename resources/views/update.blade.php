...
@section("main")
    <form action="/ubah" method="post" enctype="multipart/form-data">
        @csrf
            <div class="judul">
                <input type="text" name="judul" id="judul" placeholder="Judul Laporan/Komentar" value="{{ $posts->judul }}">
            </div>

            <textarea name="deskripsi" id="komentar" placeholder="Ceritakan detail komentar atau laporan kamu disini!">{{ $posts->deskripsi }}</textarea>
            
            <div class="bottom-form">
                <div>
                    <select id="aspek" name="aspek" value="{{ $posts->aspek }}">
                ...
                <div>
                    <input class="file-input" type="file" name="lampiran" value="/public/{{ $posts->lampiran }}">
                </div>
                <div>
